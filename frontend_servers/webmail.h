...
void deliver_local_email(const std::string& backend_serveraddr_str, int fd, const std::string& recipient, const std::string& uid, const std::string& from, const std::string& subject, const std::string& body);
...
std::string construct_view_email_html(const std::string& subject, const std::string& from, const std::string& to, const std::string& timestamp, const std::string& body, const std::string& uid);