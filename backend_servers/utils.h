...
void recover(std::unordered_map<std::string, tablet_data> &cache, std::string &data_file_location, std::vector<std::string> &server_tablet_ranges);

void update_server_tablet_ranges(std::vector<std::string> &server_tablet_ranges);
