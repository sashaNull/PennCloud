...
void print_primaries(std::unordered_map<std::string, server_info *> &range_to_primary_map);

void update_primary(std::unordered_map<std::string, server_info *> &range_to_primary_map, std::unordered_map<std::string, std::vector<server_info *>> range_to_server_map, pthread_mutex_t &map_and_list_mutex);

void initialize_primaries(std::unordered_map<std::string, server_info *> &range_to_primary_map, std::unordered_map<std::string, std::vector<server_info *>> range_to_server_map, pthread_mutex_t &map_and_list_mutex);